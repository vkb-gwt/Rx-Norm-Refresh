...
3. Identify active rows whose exact current-month version is no longer represented by the latest source data.
4. End-date the existing active rows that have expired or been replaced.
